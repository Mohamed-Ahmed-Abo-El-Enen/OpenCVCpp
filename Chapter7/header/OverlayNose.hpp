...
int OverlayNose(int argc, char* argv[])
{
    ...
    string noseCascadeName = "resources/haarcascade_mcs_nose.xml";
    ...
    // string noseFile = argv[3];
    string noseFile = "data/raw/pngegg.png";
    Mat noseMask = imread(noseFile);
