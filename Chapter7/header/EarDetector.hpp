...
int EarDetector(int argc, char* argv[])
{
    //string leftEarCascadeName = argv[1];
    //string rightEarCascadeName = argv[2];
    string leftEarCascadeName = "resources/haarcascade_mcs_rightear.xml";
    string rightEarCascadeName = "resources/haarcascade_mcs_rightear.xml";
