...
int OverlaySunglasses(int argc, char* argv[])
{
    ...
    string eyeCascadeName = "resources/haarcascade_eye.xml";
    ...
    // string eyeFile = argv[3];
    string eyeFile = "data/raw/glasses.jpg";
    Mat eyeMask = imread(eyeFile);
