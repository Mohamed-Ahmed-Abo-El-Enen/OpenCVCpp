...
void trainAndTest()
{
  ...
  // Get the nut images
  readFolderAndExtractFeatures("data/raw/nut/tuerca_%04d.pgm", 0, num_for_test, trainingData, responsesData, testData, testResponsesData);
  // Get and process the ring images
  readFolderAndExtractFeatures("data/raw/ring/arandela_%04d.pgm", 1, num_for_test, trainingData, responsesData, testData, testResponsesData);
  // get and process the screw images
  readFolderAndExtractFeatures("data/raw/screw/tornillo_%04d.pgm", 2, num_for_test, trainingData, responsesData, testData, testResponsesData);
...
int MLOpenCV(string imgFile, string lightPatternFile)
{
  ...
  // Load image to process
  light_pattern= imread(lightPatternFile, 0);
