...
int FarnebackTracker(int, char** argv)
{
    ...
    while(true)
    {
        ...
        if(prevGray.data)
        {
            ...
            calcOpticalFlowFarneback(prevGray, curGray, flowImage, pyrScale, numLevels, windowSize, numIterations, neighborhoodSize, stdDeviation, OPTFLOW_LK_GET_MIN_EIGENVALS);
